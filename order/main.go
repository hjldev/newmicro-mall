...
import (
	...
	"github.com/hjldev/newmicro-mall/order/domain/repository"
	service2 "github.com/hjldev/newmicro-mall/order/domain/service"
	"github.com/hjldev/newmicro-mall/order/handler"
	"github.com/hjldev/newmicro-mall/order/proto/order"
...
func main() {
	...
	// 3.jaeger 链路追踪
	t, io, err := common.NewTracer("top.hjlinfo.mall.order", "localhost:6831")
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
	...
	service := micro.NewService(
		micro.Name("top.hjlinfo.mall.order"),
