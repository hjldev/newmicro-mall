...
type UserService interface {
	Register(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*RegisterResponse, error)
	Login(ctx context.Context, in *LoginRequest, opts ...client.CallOption) (*LoginResponse, error)
	GetUserInfo(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*UserInfoResponse, error)
	UpdateUserInfo(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*UserInfoResponse, error)
}
...
func (c *userService) Register(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*RegisterResponse, error) {
...
func (c *userService) UpdateUserInfo(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*UserInfoResponse, error) {
...
type UserHandler interface {
	Register(context.Context, *UserInfoRequest, *RegisterResponse) error
	Login(context.Context, *LoginRequest, *LoginResponse) error
	GetUserInfo(context.Context, *UserInfoRequest, *UserInfoResponse) error
	UpdateUserInfo(context.Context, *UserInfoRequest, *UserInfoResponse) error
}

func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		Register(ctx context.Context, in *UserInfoRequest, out *RegisterResponse) error
		Login(ctx context.Context, in *LoginRequest, out *LoginResponse) error
		GetUserInfo(ctx context.Context, in *UserInfoRequest, out *UserInfoResponse) error
		UpdateUserInfo(ctx context.Context, in *UserInfoRequest, out *UserInfoResponse) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) Register(ctx context.Context, in *UserInfoRequest, out *RegisterResponse) error {
...
func (h *userHandler) UpdateUserInfo(ctx context.Context, in *UserInfoRequest, out *UserInfoResponse) error {
